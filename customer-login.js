...
(function () {
  ...
  var STYLE = [
    ...
    ".cl-pill{display:inline-flex;align-items:center;gap:7px;",
      ...
      "font:800 12.5px/1 'Montserrat',system-ui,sans-serif;",
      "letter-spacing:.05em;text-transform:uppercase;",
      "transition:all .15s;text-decoration:none;cursor:pointer;border:1.5px solid transparent}",
    ".cl-pill-primary{background:#f0271d;color:#fff!important}",
    ".cl-pill-primary:hover{background:#ff3a30;color:#fff!important;",
      "transform:translateY(-1px);box-shadow:0 10px 26px -8px rgba(240,39,29,.6)}",
    ".cl-pill-ghost{background:rgba(255,255,255,.04);color:#b0b3bd!important;border-color:rgba(255,255,255,.16)}",
    ".cl-pill-ghost:hover{border-color:#f0271d;color:#fff!important;background:rgba(240,39,29,.08)}",
    ".cl-user{display:inline-flex;align-items:center;gap:9px;",
      "font:700 13px/1 'Montserrat',system-ui,sans-serif;color:#f6f7f9;",
      "white-space:nowrap}",
    ".cl-dot{width:7px;height:7px;border-radius:50%;background:#3fb950;",
      "box-shadow:0 0 10px rgba(63,185,80,.7);flex:none}",
